...
my_agent_old = load_model("train_lunar_lander_700.h5", custom_objects={'mse': 'mse'})
...
my_agent.main_network.set_weights(my_agent_old.get_weights())
my_agent.target_network.set_weights(my_agent_old.get_weights())

for ep in range(700, n_espisodes):
    ep_rewards = 0
    state, _ = env.reset()
